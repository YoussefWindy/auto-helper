...
def paginate(max_pages):
    ...
    for i in range(int(max_pages)):
        url = "https://www.cars.com/shopping/results/?dealer_id=&keyword=&list_price_max=&list_price_min=&makes[]=&maximum_distance=500&mileage_max=&monthly_payment=&page=" + str(i + 1) + "&page_size=20&sort=best_match_desc&stock_type=used&year_max=&year_min=&zip="
...
def writeData(carData):
    if carData:
        print(len(carData))
        with open('used_cars.json','w',encoding='utf-8') as jsonfile:
